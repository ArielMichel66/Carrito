...
namespace Carrito.Data
{
    public class SeedDb
    {
        ...
        public async Task SeedAsync()
        {
            ...
            await CheckUserAsync("1010", "Ariel", "Quintana", "ariel@yopmail.com", "322 311 4620", "bolivar 1555", "Brad.jpg", UserType.Admin);
            await CheckUserAsync("1010", "Cristina", "Chamorro", "cristina@yopmail.com", "322 311 4620", "Ferre 520", "Brad.jpg", UserType.User);
