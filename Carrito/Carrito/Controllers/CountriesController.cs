...
namespace Carrito.Controllers
{
    ...
    public class CountriesController : Controller
    {
        ...
        [NoDirectAccess]   ////Dataannotation personalizado , el id nunca va a llegar null
                           ////esto permite que llegue solo x sistema
        public async Task<IActionResult> Delete(int id)
        {
            //if (id == null)          ya no tiene sentido con el NoDirectAccess
            //{
            //    return NotFound();
            //}
        ...
        public async Task<IActionResult> DeleteState(int id)
        {
            ...
            {
                _flashMessage.Danger("No se puede borrar la Provincia porque tiene registros relacionados.");
            }
